...
import 'package:flutter_sixvalley_ecommerce/common/widgets/k_title.dart';
                                              ...
                                              decoration: BoxDecoration(
                                                  ...
                                                  border: Border.all(
                                                      ...
                                                      color: index ==
                                                          ...
                                                          : Theme.of(context)
                                                              .cardColor)),
                                              child: Center(child: Text('${getTranslated(productProvider.productTypeList[index].title!, context)}', style: textMedium.copyWith(color: index == productProvider.selectedProductTypeIndex ? Theme.of(context).primaryColor : Theme.of(context).hintColor)))),
                                        ),
                                      );
                                    }),
                              ),
