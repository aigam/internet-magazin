...
class CartProvider extends ChangeNotifier {
  ...
  Future<ResponseModel> updateCartProductQuantity(int? key, int quantity,
    ...
    if (apiResponse.response != null &&
      ...
      updatingIncrement = false;
      updatingDecrement = false;
  ...
  void setSdek(bool val, int id) {
    sdek = val;
    sdekId = id;
    notifyListeners();
  }

  void setSdekPvz(PvzModel val) {
    pvz = val;
    sdekPrice = val.price ?? 0;
    notifyListeners();
  }
  ...
  Future addShippingMethod(
    ...
    ApiResponse apiResponse =
        await cartRepo!.addShippingMethod(id, cartGroupId, pvz);
    if (apiResponse.response != null &&
        apiResponse.response!.statusCode == 200) {
