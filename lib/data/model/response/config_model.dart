class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    if(json['minimum_add_fund_amount'] != null){
      minimumAddFundAmount = int.parse(json['minimum_add_fund_amount'].toString());
    }else{
      minimumAddFundAmount = 0;
    }

    if(json['maximum_add_fund_amount'] != null){
      maximumAddFundAmount = int.parse(json['maximum_add_fund_amount'].toString());
    }else{
...
class PopularTags {
  ...
  PopularTags(
      {this.id, this.tag, this.visitCount, this.createdAt, this.updatedAt});
